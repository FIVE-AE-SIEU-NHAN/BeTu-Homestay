    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-2 bg-white/60 backdrop-blur-sm rounded-2xl p-2 shadow-soft">
              ...
              <motion.button
                ...
                className={`relative flex items-center space-x-2 px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 ${
                  activeSection === item.id
                    ...
                    : "text-orange-700 hover:text-orange-600 hover:bg-orange-50/80"
                }`}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => onSectionChange("rooms", "room-selection")}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden glass-effect border-t border-orange-200/50 mx-4 mb-4 rounded-2xl overflow-hidden"
          >
